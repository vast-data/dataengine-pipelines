...
| python-s3-segment-video | s3 | Python 3.12.12 | [link](https://github.com/vast-data/dataengine-pipelines/tree/main/python-s3-segment-video) | Pipeline with S3 trigger that segments uploaded .mp4 files into fixed-duration clips. |
